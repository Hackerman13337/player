  ...
  function(Player,$,opts){
      ...
      $this.load = function(callback){
          ...
          if(!window.settingsData){
              methods.push({
                  ...
                  data:{
                    ...
                    _li:(Cookie.get('ad_user_login')!=''?'1':'0'),
                    _bot:(/googlebot|bingbot|crawler|spider|robot|crawling/i.test(navigator.userAgent)?'1':'0')
                  },
          ...
          methods.push({
              ...
              data:$.extend({size:10, include_actions_p:1, include_revision_p:1}, Player.parameters, {player_id:$this.settings.player_id}),
...
var Persist = {
    set: function(name, value, daysToExpire) {LocalStorage.set(name,value); Cookie.set(name,value,daysToExpire||90);},
